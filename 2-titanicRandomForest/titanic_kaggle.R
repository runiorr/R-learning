#Chamando os pacotes que irei utilizar
...
#Formatando a tabela
tabela_importancia <- data.frame(variaveis=row.names(importance_var),
                                 importancia=importance_var[,1]);tabela_importancia

#Gerando o grafico
grafico <- ggplot(tabela_importancia,
